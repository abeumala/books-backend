...
describe("/users unit test",function(){
  ...
  it("should return a user",function(done){
  	var user1 = JSON.parse(fs.readFileSync('test/fakeData/individualUserData1.json', 'utf8'));
  	var user2 = JSON.parse(fs.readFileSync('test/fakeData/individualUserData2.json', 'utf8'));
    // calling houser page api
	  server
	    .get("/users/"+user2._id)
