...
describe("Post unit test",function(){
	...
	it("should authenticate individual user 1",function(done){
		...
		var user = JSON.parse(fs.readFileSync('test/fakeData/individualUserData2.json', 'utf8'));
	    // calling home page api
      	server
	    .post("/authenticate")
	    .send({username : user.username, password : user.password})
	...
	it("should authenticate business user",function(done){
	...
	it("should not found any individual hotspot",function(done){
		var user = JSON.parse(fs.readFileSync('test/fakeData/individualUserData1.json', 'utf8'));
		var hotspot = JSON.parse(fs.readFileSync('test/fakeData/individualHotspotData.json', 'utf8'));
	    // calling home page api
	...
	it("should not found any business hotspot",function(done){
		var user = JSON.parse(fs.readFileSync('test/fakeData/businessUserData.json', 'utf8'));
		var hotspot = JSON.parse(fs.readFileSync('test/fakeData/businessHotspotData.json', 'utf8'));
	    // calling home page api
