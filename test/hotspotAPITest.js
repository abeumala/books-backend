...
describe("/hotspots unit test",function(){
	...
	/*it("should create a hotspot", function(done) {
	  	var user = JSON.parse(fs.readFileSync('fakeData/userData.json', 'utf8'));
	  	server
	    .post("/hotspots")
	...
	it("should not allow to invite from non owner hotspot", function(done) {
	  	var individualUser1 = JSON.parse(fs.readFileSync('fakeData/individualUserData1.json', 'utf8'));
	  	var individualUser2 = JSON.parse(fs.readFileSync('fakeData/individualUserData2.json', 'utf8'));
	  	var individualHotspot = JSON.parse(fs.readFileSync('fakeData/individualHotspotData.json', 'utf8'));
